	...
	<div class="section section-pile bg-gray">
		<div class="container">
			<div class="pile-wrapper d-flex align-items-center">
				<div class="pile-img">
					<img class="img-full" src="./assets/images/pile-1.jpg" alt="Image">
				</div>
				<div class="pile-box box-shadow">
					<h1 class="section-title">Corporate Innovation Lab</h1>
	...
	<div class="section bg-gray">
		<div class="container">
			...
			<div class="section-results">
				...
				<h2 class="section-title section-title--full">What to expect from our Corporate innovation Lab?</h2>
